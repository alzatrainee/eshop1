...
namespace Pernicek.Controllers
{
    public class ItemController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var result = _catalogService.GetProduct(4);
            ...
            //var category = _catalogService.Get_Product_cat(result.id_pr);
            //List<Catalog.Dal.Entities.> pom = new List<Catalog.Dal.Entities.Colour>();
